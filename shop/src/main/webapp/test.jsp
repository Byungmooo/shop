      ...
      <div class="carousel-item">
        <div class="carousel-container">
          ...
          <p class="animate__animated fanimate__adeInUp"> 환영합니다. 관리자 로그인을 해주세요.</p>
          		...
          		<div class="col-md-6 form-group">
                  <input type="text" name="name" class="form-control" id="name" placeholder="Your ID" required>
                </div>
                <hr>
                <div class="col-md-6 form-group">
                  <input type="password" name="name" class="form-control" id="name" placeholder="Your Password" required>
                </div>
          <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">step login</a>
        </div>
      </div>
